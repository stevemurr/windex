...
JOBS: dict[str, Job] = {j.name: j for j in [
    ...
    Job("arxiv-backfill", ("arxiv", "harvest"), "windex arxiv harvest --from-year",
        ...
        confirm=True),
    Job("arxiv-embed", ("arxiv", "embed"), "windex arxiv embed",
        "Embed papers", "Embed staged arXiv papers into the index",
        "arxiv", {"limit": Param("--limit", "int", 1, 10000000, default=100000)}),
    ...
    Job("smallweb-embed", ("smallweb", "embed"), "windex smallweb embed",
        "Embed posts", "Embed staged Small Web posts into the index",
        "smallweb", {"limit": Param("--limit", "int", 1, 10000000, default=100000)}),
    ...
    Job("docs-embed", ("docs", "embed"), "windex docs embed",
        "Embed pages", "Embed staged documentation pages into the index",
        "docs", {"limit": Param("--limit", "int", 1, 10000000, default=100000)}),
    ...
    Job("hn-backfill", ("hn", "backfill"), "windex hn backfill",
        ...
        confirm=True),
    Job("hn-embed", ("hn", "embed"), "windex hn embed",
        "Embed stories", "Embed staged Hacker News stories into the index",
        "hn", {"limit": Param("--limit", "int", 1, 10000000, default=100000)}),
