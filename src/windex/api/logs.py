...
LOGS: dict[str, LogSource] = {s.name: s for s in [
    ...
    *_JOB_LOGS,
    LogSource("refresh", "Refresh sweep", "windex refresh — per-source fetch/stage", "maintenance",
              path=LOG_DIR / "refresh.log"),
    LogSource("maintain", "Store maintenance", "windex maintain — VACUUM/ANALYZE", "maintenance",
              path=LOG_DIR / "maintain.log"),
