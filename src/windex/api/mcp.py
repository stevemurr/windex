...
mcp = FastMCP(
    ...
    "Wikipedia articles, and arXiv papers. Use search_index to find links; "
    "get_document to read a result's full text.",
)
...
def search_index(
    ...
    """Search the index. source: news | github | wiki | arxiv | all. `category`
    filters arxiv results by primary category (e.g. cs.LG). Returns ranked results
...
def get_document(doc_id: str) -> dict:
    ...
    (news:<hash>, gh:owner/repo, wiki:<page_id>, or arxiv:<paper_id>)."""
