...
mcp = FastMCP(
    "windex",
    instructions="Self-hosted web index: fresh news (CC-News) and GitHub projects. "
    "Use search_index to find links; get_document to read a result's full text.",
)
...
def search_index(
    ...
    """Search the index. source: news | github | all. Returns ranked results
